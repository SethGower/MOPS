...
///
char *StrTestData[] = {"car",    "Ford", "Chevy",
                       "Toyota", "Jeep", "Samsung",
                       "Apple",  "HTC",  "abcdefghijklmnopqrstuvwxyz",
                       "12345"};
int NumStrData = 10;

unsigned int UintTestData2[] = {2008, 1993, 1989, 1985, 2016,
                                1991, 2005, 2002, 1987, 1990};
int NumUintData2 = sizeof(UintTestData2) / sizeof(unsigned int);

UserStruct UserData[] = {
    {297066, "Elliott", "Jeannie"},
    {498400, "Sparks", "Leigh"},
    {321438, "Mendoza", "Glen"},
    {305834, "Adams", "Luke"},
    {356597, "Brewer", "Caledonia"},
    {383011, "Clark", "Gregory"},
    {128604, "Townsend", "Sadie"},
    {153315, "Powell", "Colleen"},
    {242118, "Carlson", "Russell"},
    {176831, "Park", "Misty"},
    {157253, "Figueroa", "Edna"},
    {188625, "Fenstermacher", "Timothy"},
    {215653, "Burgess", "Rolando"},
    {305644, "Baskerville", "Montgomery"},
    {455921, "Tate", "Maria"},
    {356639, "Castro-Herrera", "Ella"},
    {419381, "Jimenez", "Christian"},
    {421006, "Stevenson", "Allan"},
    {240662, "Williams", "Bethany"},
    {422251, "D'Ippolito", "Mona"},
    {291516, "Mckenzie", "Mable"},
    {319642, "Cannon", "Rogelio"},
    {342336, "Maxwell", "Dewey"},
    {198308, "Champion-Demers", "Tara"},
    {254511, "West", "Christy"},
    {244956, "Barnes", "Claudia"},
    {302203, "Yates", "Angelica"},
    {387826, "Farmer", "Fred"},
    {152411, "Arnold", "Josephine"},
    {385473, "Kelly", "Karen"},
    {210572, "DeFrancesco", "Kerry"},
    {301833, "Estrada", "Omar"},
    {138056, "Wright", "Brad"},
    {121926, "Owen", "Jon"},
    {116518, "Padilla", "Kevin"},
    {293528, "Shelton", "Evangeline"},
    {231951, "Castro", "Louis"},
    {208811, "Perez", "Leon"},
    {489665, "Myers", "Manuel"},
    {345588, "Pope", "Pierre-Andre"},
    {299032, "Hale", "Craig"},
    {184563, "Chesterfield", "Clayton"},
    {143638, "Simpson", "Linda"},
    {107591, "Vanderheyden", "Julius"},
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        if (NULL == retVal) {
            ...
            printf("   key (%u/%s/%s) -- value:%u %s %u\n", tmp->idNumber,
                   tmp->lname, tmp->fname, retVal->year, retVal->note,
                   retVal->idNumber);
        }
    }
